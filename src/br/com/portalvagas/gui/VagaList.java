 ...
 */
public class VagaList extends javax.swing.JFrame {

    /**
     * Creates new form VagaList
     */
    ...
    public VagaList() {
        ...
        for (Vaga vagas : vs.findAll()) {
            modelo.addColumn(vagas.getTituloVaga());
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listagem de Vagas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VagaList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
